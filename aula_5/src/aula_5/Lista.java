...
public class Lista {
	...
	public void ex2(Scanner input) {
		double altura;
		double alturaMax = -9999999;
		double alturaMin = 9999999;
		for (int i = 1; i <= 5; i++) {
	...
	public void ex3(Scanner input) {
		...
		int num;
		int positivos = 0, negativos = 0, total = 0, somaTotal = 0;
		while (true) {
		...
		double porcPositivos = 0, porcNegativos = 0, media = 0;
		media = (double)somaTotal / total;
		
		porcPositivos = ((double)positivos / total) * 100;
		porcNegativos = ((double)negativos / total) * 100;
